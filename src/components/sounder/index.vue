<template>
  <div class="audio-container">
    ...
    <div class="audio-main" @mousemove.prevent="volumeClickMove($event)" @mouseup="volumeMoveFlag = false"
      ...
      <div ref="ProgressDom" progress="true"
        ...
        <!-- 缓冲 -->
        <div v-for="cache in playState.bufferList" progress="true" class="cache" :style="{
  ...
  {{ lrc.txt }}</p> -->
    ...
    <div ref="musicListDom" :class="['music-list', playState.playList ? 'show-list' : '']">
      <div v-for="(music, i) in musicList" :class="[playState.index === i ? 'cur' : '']"
...
import {nextTick, onBeforeUnmount, reactive, ref, Ref, watch} from 'vue';
